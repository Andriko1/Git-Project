    ...
    public void SpawnPU(float r, Vector2 position)
    {
        switch (r) {
            case float f when f > 0.0f && f <= _nukeWeight:
                ...
                PU1.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Textures/HexagonFlatTop");
            ...
            case float f when f > _nukeWeight & f <= _healthWeight + _nukeWeight:
                ...
                PU2.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Textures/Square");
                ...
                othersprite.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Textures/Square");
            ...
            case float f when f > _healthWeight + _nukeWeight & f <= _gunWeight + _healthWeight + _nukeWeight:
                ...
                PU3.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Textures/Circle");
